...
export const soloLandingDataByKey: Record<SoloLandingKey, SoloLandingData> = {
  ...
  "werewolf-game-browser": {
    ...
    faqs: [
      ...
      { question: "Is my progress saved?", answer: "Yes—your progress and settings are saved in your browser." },
    ],
  ...
  "free-werewolf-game-online": {
    ...
    tagline: "Play with your own API key.",
    heroDescription:
      "Wolfcha runs in your browser with an OpenAI-compatible BaseUrl + API Key you provide. No account, no paywall from us—just bring your model and start playing.",
    problemsSolved: [
      "Don't want to create an account",
      "Prefer using your own AI provider",
      "Need transparent usage costs",
      "Want local settings in the browser",
      "Avoid ads and interruptions",
    ],
    howItWorks: [
      { step: "Visit Wolfcha", description: "No account required." },
      { step: "Configure BaseUrl + API Key", description: "Use your preferred provider." },
      { step: "Choose a model", description: "Any OpenAI-compatible model works." },
      { step: "Play immediately", description: "Full game access from the start." },
      { step: "Saved locally", description: "Settings and progress stay in your browser." },
    ],
    uniqueFeatures: [
      { title: "Bring your own key", description: "Use any OpenAI-compatible provider." },
      { title: "No account required", description: "Start playing without sign-up." },
      { title: "Local settings & saves", description: "Progress and settings are stored in your browser." },
      { title: "No ads during play", description: "Your game isn't interrupted by advertisements." },
    ],
    comparisonTable: [
      { feature: "App cost", traditional: "Varies ($0–$30)", wolfcha: "Free (BYO API)" },
      ...
      { feature: "Full experience", traditional: "Often requires purchase", wolfcha: "Available with your API key" },
    ],
    seats: baseSeats,
    dialogues: [
      {
        ...
        lines: [
          ...
          { speaker: { seed: "morgan-02", name: "Morgan", modelLogo: "/models/gemini.svg", meta: "honest" }, content: "Bring your own API key and you're good to go." },
        ],
      },
      {
    ...
    faqs: [
      { question: "Is it really free?", answer: "The app is free. Your AI provider may charge for API usage." },
      { question: "How does Wolfcha make money?", answer: "It doesn't require payment. Community sponsorship keeps it going." },
      { question: "Will free features ever become paid?", answer: "Core gameplay stays free; you only cover your API usage." },
      { question: "Are there ads?", answer: "No ads interrupt your gameplay. We believe ads ruin the experience." },
      { question: "What do premium features include?", answer: "There are no premium features—just bring your own API key." },
      { question: "Is this too good to be true?", answer: "It's simple: you bring the model, we run the game." },
    ],
