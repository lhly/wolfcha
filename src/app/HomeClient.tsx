...
import { PHASE_CONFIGS, isGameInProgress, rawGameStateAtom } from "@/store/game-machine";
...
export default function HomeClient({ initialLlm, initialGame, initialTotpAuthed }: HomeClientProps) {
  ...
  const initialValues = useMemo(() => {
    if (!initialGame?.state) return [];
    return [[rawGameStateAtom, initialGame.state]] as const;
  }, [initialGame]);
